...
```{r echo=FALSE}
cernar_result <- read.csv('~/demo-DLBC/demo-DLBC_finalpairs.csv')
...
```{r echo=FALSE}
cernar_result <- read.csv("/Users/ywhsiao/demo-DLBC/04_downstreamAnalyses/external_validation/demo-DLBC_with_target_exp_evidence.csv")
knitr::kable(cernar_result[1:5,])
```
