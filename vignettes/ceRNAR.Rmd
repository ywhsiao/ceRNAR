...
<img src="https://raw.githubusercontent.com/ywhsiao/ceRNAR/master/vignettes/figure/mechanism_of_ceRNA.png" alt="ceRNA principle" style="width: 600px; display: block; margin-left: auto; margin-right: auto;"/>
...
```{r echo=FALSE}
knitr::kable(cernar_result[1:5,], row.names = FALSE)
```
...
```{r echo=FALSE}
ceRNAFunction(path_prefix = '~/', project_name = 'demo', disease_name = 'DLBC', pairs_cutoff = 1)[[1]]
```

```{r echo=FALSE}
ceRNAFunction(path_prefix = '~/', project_name = 'demo', disease_name = 'DLBC', pairs_cutoff = 1)[[2]]
```
...
This function allows users to further combine our results with other state-of-the-art tools in ceRNA biological field, including SPONGE [6] and JAMI [7].
